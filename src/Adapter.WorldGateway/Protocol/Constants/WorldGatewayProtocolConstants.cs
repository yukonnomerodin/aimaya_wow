...
internal static class WorldGatewayProtocolConstants
{
    ...
    internal const byte AuthResponseResultCodeAuthOk = 0x0C;
    internal const byte AuthResponseResultCodeAuthWaitQueue = 0x1B;
    internal const byte AuthResponseExpansionWotlk = 2;
    internal const byte AuthResponseExpansionTww = 10;
    internal const string AuthResponseRealmNameAzerothCore = "AzerothCore";
    internal const string AuthResponseProbeRealmNameAimaya = "AIMAYA";
    internal const byte AuthResponseClassIdMonk = 10;
    internal const byte AuthResponseClassIdDemonHunter = 12;
    internal const byte AuthResponseClassIdEvoker = 13;
    internal const byte AuthResponseClassMinExpansionMonk = 5;
    internal const byte AuthResponseClassMinExpansionDemonHunter = 6;
    internal const byte AuthResponseClassMinExpansionEvoker = 10;
