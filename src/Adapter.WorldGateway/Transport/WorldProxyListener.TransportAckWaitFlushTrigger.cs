...
{
    private readonly record struct AckGateWaitAndFlushTriggerResult(
        bool ShouldTerminateConnection,
        bool ShouldFlushDeferredNow,
        string DeferredFlushPath);

    private AckGateWaitAndFlushTriggerResult ResolveAckGateWaitAndFlushTrigger(
        uint connectionId,
        WorldProxyBridgeState bridgeState)
    {
        ...
        if (!acked)
        {
            ...
            else
            {
                ...
                return new AckGateWaitAndFlushTriggerResult(
                    ShouldTerminateConnection: true,
                    ShouldFlushDeferredNow: false,
                    DeferredFlushPath: "<none>");
            }
        }
        ...
        return new AckGateWaitAndFlushTriggerResult(
            ...
            ShouldFlushDeferredNow: shouldFlushDeferredNow,
